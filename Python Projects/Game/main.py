...
class Soldier(pygame.sprite.Sprite):
    def __init__(self,char_type, x, y, scale,speed,ammo):
        ...
        for animation in animation_types:
            # reset temperary list of images
            temp_list = []
        ...
        self.rect = self.image.get_rect()                   # for controlling
    ...
    def update_animation(self):
        ...
        #update image dependingon current frames
...
class  Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.right <0 or self.rect.left > SCREEN_WIDTH:
            self.kill()
        # check if collision with characters
...
while run==True:
    ...
    if player.alive:
        ...
        if player.in_air:
            ...
            player.update_action(0)  # 0:stand
